...
export default function LearnerInformation({
  ...
  return (
    <>
          ...
          <div key={index} className="grid grid-wrap">
            ...
            <div className="sub-section size_1-of-1 grid grid-wrap">
              <div className="size_1-of-1 medium-size_1-of-3 padding-around_small">
                ...
                />
                {learner.Information.PresentGrade_error && (
              ...
              <div className="size_1-of-1 medium-size_1-of-3 padding-around_small">
                <Text
                  ...
                  value={learner.Information.PresentYear}
                  onChange={(value) =>
                    handleInputChange(index, "PresentYear", value)
                  }
                />
                {learner.Information.PresentYear_error && (
                  <div className="error color-error">
                    {learner.Information.PresentYear_error}
                  </div>
                )}
              ...
              <div className="size_1-of-1 medium-size_1-of-3 padding-around_small">
                ...
                />
                {learner.Information.YearsIngGrade_error && (
                  <div className="error color-error">
                    {learner.Information.YearsIngGrade_error}
                  </div>
                )}
              ...
              <div className="size_1-of-1 medium-size_1-of-3 padding-around_small">
                ...
                />
                {learner.Information.PresentSchool_error && (
                  <div className="error color-error">
                    {learner.Information.PresentSchool_error}
                  </div>
                )}
            ...
            <div className="size_1-of-1 medium-size_1-of-3 padding-around_small">
              ...
              />
              {learner.Information.firstName_error && (
                <div className="error color-error">
                  {learner.Information.firstName_error}
                </div>
              )}
            ...
            <div className="size_1-of-1 medium-size_1-of-3 padding-around_small">
              ...
              />
              {learner.Information.lastName_error && (
                <div className="error color-error">
                  {learner.Information.lastName_error}
                </div>
              )}
            ...
            <div className="size_1-of-1 medium-size_1-of-3 padding-around_small">
              ...
              />
              {learner.Information.initials_error && (
                <div className="error color-error">
                  {learner.Information.initials_error}
                </div>
              )}
            ...
            <div className="size_1-of-1 medium-size_1-of-3 padding-around_small">
              ...
              />
              {learner.Information.Gender_error && (
                <div className="error color-error">
                  {learner.Information.Gender_error}
                </div>
              )}
            ...
            <div className="size_1-of-1 medium-size_1-of-3 padding-around_small">
              ...
              />
              {learner.Information.race_error && (
                <div className="error color-error">
                  {learner.Information.race_error}
                </div>
              )}
            ...
            <div className="size_1-of-1 medium-size_1-of-3 padding-around_small">
              ...
              />
              {learner.Information.IDNumber_error && (
                <div className="error color-error">
                  {learner.Information.IDNumber_error}
                </div>
              )}
            ...
            <div className="size_1-of-1 medium-size_1-of-3 padding-around_small">
              ...
              />
              {learner.Information.Country_of_residence_error && (
                <div className="error color-error">
                  {learner.Information.Country_of_residence_error}
                </div>
              )}
            ...
            <div className="size_1-of-1 medium-size_1-of-3 padding-around_small">
              ...
              />
              {learner.Information.Citizenship_error && (
                <div className="error color-error">
                  {learner.Information.Citizenship_error}
                </div>
              )}
            ...
            <div className="size_1-of-1 medium-size_1-of-3 padding-around_small">
              ...
              />
              {learner.Information.Home_tell_error && (
                <div className="error color-error">
                  {learner.Information.Home_tell_error}
                </div>
              )}
            ...
            <div className="size_1-of-1 medium-size_1-of-3 padding-around_small">
              ...
              />
              {learner.Information.Emergency_tell_error && (
                <div className="error color-error">
                  {learner.Information.Emergency_tell_error}
                </div>
              )}
            ...
            <div className="size_1-of-1 medium-size_1-of-3 padding-around_small">
              ...
              />
              {learner.Information.home_language_error && (
                <div className="error color-error">
                  {learner.Information.home_language_error}
                </div>
              )}
            ...
            <div className="size_1-of-1 medium-size_1-of-3 padding-around_small">
              ...
              />
              {learner.Information.preferred_language_of_instruction_error && (
                <div className="error color-error">
                  {learner.Information.preferred_language_of_instruction_error}
                </div>
              )}
            ...
            <div className="size_1-of-1 medium-size_1-of-3 padding-around_small">
              <Select
                ...
                value={learner.Information.DexterityOfLearner}
                onChange={(value) =>
                  handleInputChange("DexterityOfLearner", value)
                }
              />
            </div>
            <div className="size_1-of-1 medium-size_1-of-3 padding-around_small">
            ...
            <div className="size_1-of-1 padding-top_large padding-bottom_large">
              {index > 0 && (
                <Button
                  variant="submit"
      ...
      <div>
        <Button variant="submit" label="Add Learner" onClick={onAddLearner} />
      </div>
    </>
  );
}
