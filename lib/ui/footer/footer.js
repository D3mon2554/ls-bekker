        ...
        <div className={`${styles.tabContainer} `}>
          ...
          <Link
            ...
            className={`${styles.content} ${
              isLinkActive("about/our-purpose") ? styles.active : ""
            }`}
          >
            About us
          </Link>
          ...
          <div ref={schoolDropdownRef}>
            <div
              className={`${styles.dropdownToggle} ${
                ...
                isLinkActive("/about/our-school") ||
                isLinkActive("/about/our-pre-primary")
                  ? styles.active
                  : ""
              }`}
          ...
          <div ref={hostelDropdownRef}>
            <div
              ...
              } ${isLinkActive("/hostel/our-hostel") ? styles.active : ""}`}
    ...
    >
      ...
      >
        ...
        <div className="grid grid-align_vertical-center padding-bottom_xx-large grid-align_horizontal-even size_1-of-1">
          ...
          <div className="">
            <Link href="/about/our-purpose" className={`${styles.home}`}>
              About
            </Link>
          </div>
          <div className="">
