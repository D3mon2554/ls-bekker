...
const DayScholarPDFDocument = ({ formData, Files }) => {
  if (!formData) {
    return null;
  }
      ...
      <Page size="A4">
        ...
        <View style={styles.mainSection}>
          ...
          <View style={styles.sectionContainer}>
            ...
            <View style={styles.textElementContainerFees}>
              <Text style={styles.textContainerTitleFees}>School fees</Text>
              <Text style={styles.textContainerTitle}>
                Annual Fees: R 12 870.00
              </Text>
              <Text style={styles.textContainerTitle}>
                Annually (before the end of Feb 2024) R 11 700. (10 % discount
                for advance payment)
              </Text>
              <Text style={styles.textContainerTitle}>Quarterly payments:</Text>
              <Text style={styles.textContainerTitle}>
                1st Quarter – R 3 510.00
              </Text>
              <Text style={styles.textContainerTitle}>
                2nd Quarter – R 3 510.00
              </Text>
              <Text style={styles.textContainerTitle}>
                3rd Quarter – R 3 510.00
              </Text>
              <Text style={styles.textContainerTitle}>
                4th Quarter – R 2 340.00
              </Text>
              <Text style={styles.textContainerTitle}>Monthly payments:</Text>
              <Text style={styles.textContainerTitle}>
                Monthly payments of R 1 170.00 by EFT before the 7th of each
                month
              </Text>
            </View>
          </View>
...
export default DayScholarPDFDocument;
