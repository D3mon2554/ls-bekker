...
const styles = StyleSheet.create({
  ...
  textReason: {
    ...
    flexWrap: "wrap", // Wrap items to the next row when needed
    marginBottom: 5,
    width: "100%", // Each container takes 30% of the page width
    alignItems: "center",
  },
  ...
  textElementReason: {
    width: "25%", // Each container takes 30% of the page width
    marginBottom: 5,
    padding: 5,
  },
});
...
const HostelPDFDocument = ({ formData, Files }) => {
  ...
  const dynamicStyle = (text) => {
    return text && text.length > 50 ? { width: "100%" } : { width: "33%" };
  };
  return (
    <Document>
      {/* Learner Information */}
        ...
        <View style={styles.mainSection}>
          ...
          <View style={styles.sectionContainer}>
            <View style={styles.textElementContainer}>
              ...
              <Text style={styles.textElement}>
                {formData.HostelQuestions.information.academicachievements}
              </Text>
            </View>
            <View style={styles.textElementContainer}>
              <Text style={styles.textContainerTitle}>
              ...
              <Text style={styles.textElement}>
                {formData.HostelQuestions.information.extramuralactivities}
              </Text>
            </View>
            <View style={styles.textReason}>
              <Text style={styles.textContainerTitle}>
                REASONS for placing the child / children in a hostel:
              </Text>
              <Text style={styles.textElement}>
                {formData.HostelQuestions.information.reasonforplacingchild}
              </Text>
            </View>
            <View style={styles.textElementContainer}>
              <Text style={styles.textContainerTitle}>
                Does your child have any medical condition that we need to know
                of?
              </Text>
              <Text style={styles.textElement}>
                {formData.HostelQuestions.information.medicalcontitions}
              </Text>
            </View>
            <View style={styles.textElementContainer}>
              <Text style={styles.textContainerTitle}>
              ...
              <Text style={styles.textElement}>
                {formData.HostelQuestions.information.bedwetting}
              </Text>
            </View>
            <View style={styles.textElementContainer}>
              <Text style={styles.textContainerTitle}>
                Does your child take any chronic medicine that we have to
                administer through the week:
              </Text>
              <Text style={styles.textElement}>
                {formData.HostelQuestions.information.medicine}
              </Text>
            </View>
            <View style={styles.textElementContainer}>
              <Text style={styles.textContainerTitle}>
              ...
              <Text style={styles.textElement}>
                {formData.HostelQuestions.information.allergicmedicine}
              </Text>
            </View>
            <View style={styles.textElementContainer}>
              <Text style={styles.textContainerTitle}>
              ...
              <Text style={styles.textElement}>
                {formData.HostelQuestions.information.allergicfood}
              </Text>
            </View>
            <View style={styles.textReason}>
              <Text style={styles.textContainerTitle}>I </Text>
              <View style={styles.textElementReason}>
                <Text style={styles.textElement}>
                  {formData.HostelQuestions.information.object}
                </Text>
              </View>
              <Text style={styles.textContainerTitle}>
                {" "}
                to my child reasonably participating in the extramural
                activities of the School and Hostel.
              </Text>
            </View>
          </View>
        </View>
      </Page>
      {/* Medical and Contact details school */}
      <Page size="A4">
        <View style={styles.mainSection}>
        ...
        <View style={styles.mainSection}>
          ...
          <View style={styles.sectionContainer}>
            ...
            <View style={styles.textElementContainer}>
              ...
              <Text style={styles.textElement}>
                {formData.Acknowledgement.information.Marketing}
              </Text>
            </View>
          </View>
        </View>
